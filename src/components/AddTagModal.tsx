...
import type { Season, MezastarTag } from '../types';
...
interface AddTagModalProps {
  ...
  onClose: () => void;
  onAddTag: (tag: Omit<MezastarTag, 'id'>, initialQty: number) => void;
}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label htmlFor="add-tag-no" className="text-xs font-bold text-secondary">Mã Số Thẻ *</label>
              <input
                id="add-tag-no"
                type="text"
            ...
            {/* Pokémon Name */}
            <div className="space-y-1">
              <label htmlFor="add-tag-name" className="text-xs font-bold text-secondary">Tên Pokémon *</label>
              <input
                id="add-tag-name"
                type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            {/* Rarity */}
            <div className="space-y-1">
              <label htmlFor="add-tag-rarity" className="text-xs font-bold text-secondary">Độ Hiếm / Nhãn</label>
              <select
                id="add-tag-rarity"
                value={rarity}
                onChange={(e) => setRarity(e.target.value as MezastarTag['rarity'])}
            ...
            {/* Pokémon Type */}
            <div className="space-y-1">
              <label htmlFor="add-tag-type" className="text-xs font-bold text-secondary">Hệ Pokémon</label>
              <select
                id="add-tag-type"
                value={type}
          ...
          <div className="grid grid-cols-2 gap-4">
            {/* Season target */}
            <div className="space-y-1">
              <label htmlFor="add-tag-season" className="text-xs font-bold text-secondary">Cho vào Mùa (Season)</label>
              <select
                id="add-tag-season"
                value={seasonId}
            ...
            {/* Initial Quantity */}
            <div className="space-y-1">
              <label htmlFor="add-tag-quantity" className="text-xs font-bold text-secondary">Số Lượng Sở Hữu Ban Đầu</label>
              <input
                id="add-tag-quantity"
                type="number"
                min="0"
          ...
          {/* Image URL */}
          <div className="space-y-1">
            <label htmlFor="add-tag-image-url" className="text-xs font-bold text-secondary flex items-center space-x-1">
          ...
          {/* Notes */}
          <div className="space-y-1">
            <label htmlFor="add-tag-notes" className="text-xs font-bold text-secondary">Ghi chú nhanh</label>
            <textarea
              id="add-tag-notes"
          ...
          <div className="flex items-center justify-end space-x-3 pt-2">
            ...
            <button
              type="submit"
              className="inline-flex items-center space-x-1.5 bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-500 hover:to-teal-400 text-white font-bold text-sm px-5 py-2.5 rounded-xl transition-all shadow-md shadow-emerald-950/20 active:scale-98"
            >
