      ...
      <div className="mx-auto flex max-w-7xl h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-black tracking-tight text-primary sm:text-xl flex items-center">
              MEZASTAR <span className="ml-1.5 text-xs font-bold px-1.5 py-0.5 rounded bg-rose-500/20 text-rose-400 border border-rose-500/30">DEX</span>
            </h1>
            <p className="text-[10px] text-secondary -mt-1 hidden sm:block">Personal Collection Tracker</p>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-4">
          <div className="flex items-center space-x-2 bg-badge px-3.5 py-1.5 rounded-xl border border-primary">
            ...
            <span className="text-xs font-semibold text-secondary">Bộ sưu tập:</span>
            <span className="text-sm font-bold text-primary">{collectedCount} / {totalCount}</span>
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-primary bg-panel text-secondary transition-colors hover:bg-badge hover:text-primary"
          >
            {theme === 'dark' ? (
          ...
          <button
            onClick={onReset}
            title="Xóa hết dữ liệu sưu tập"
            className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-red-900/30 bg-red-950/20 text-red-400 transition-colors hover:bg-red-900/30 hover:text-red-300"
          >
